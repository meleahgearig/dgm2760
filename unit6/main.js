function tellStory() {
    ...
    Her name was really Ruby but her stepsisters called her that because
    ...
    Cinderella's fairy <span>${nounArray[2]}</span> came to help. She used her magic and 
    ...
    or the magic would <span>${verbArray[0]}</span>!`
